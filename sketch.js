...
function draw(){
   ...
   if (mouseIsPressed){
         ...
         for (var i = 0; i < 3; i++){
               balls.push(new Ball(mouseX/2, mouseY/2, color(capture.get(mouseX/2+random(2), mouseY/2+random(2)))));
         }
...
class Ball{
         ...
         draw(){
               ...
               ellipse(this.location.x*2, this.location.y*2, this.radius*2, this.radius*2);
         }
   }